...
function populateReferralForm(referral_data) {
    ...
    $.each(referral_data.patient_results, function(idx, record){
        $("#referral-phn").append("<option value='" + record.phn + "'>" + record.phn + " - " + record.f_name + " " + record.l_name + "</option>")
    });

    // Populate staff info
    $.each(referral_data.staff_info, function (idx, record){
        $("#referral-licencenumber").append("<option value='" + record.licenseno + "'>" + record.licenseno + " - " + record.f_name + " " + record.l_name + "</option>")
    });
